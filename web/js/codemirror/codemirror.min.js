!(function (e, t) {
    ...
    var Fe,
        ...
        Re = function (e, t) {
            ...
            return (
                "ltr" == t &&
                    (1 == A[0].level && (O = e.match(/^\s+/)) && ((A[0].from = O[0].length), A.unshift(new Be(0, 0, O[0].length))),
                    1 == z(A).level && (O = e.match(/\s+$/)) && ((z(A).to -= O[0].length), A.push(new Be(0, i - O[0].length, i)))),
                "rtl" == t ? A.reverse() : A
            );
        };
    function Be(e, t, n) {
    ...
    function T(e, t, n) {
        ...
        e.removeEventListener
            ...
            : (r = (e = e._handlers) && e[t]) && -1 < (n = L(r, n)) && (e[t] = r.slice(0, n).concat(r.slice(n + 1)));
    }
    function O(e, t) {
        var n = Ve(e, t);
    ...
    (g.prototype.eol = function () {
        ...
        (g.prototype.column = function () {
            return (
                this.lastColumnPos < this.start && ((this.lastColumnValue = S(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
    ...
    function Ot(e, t, n) {
        ...
        return (
            (t.styles && t.styles[0] == e.state.modeGen) ||
                ((r = At(e, H(t))),
                (i = t.text.length > e.options.maxHighlightLength && ht(e.doc.mode, r.state)),
                (o = Nt(e, t, r)),
                i && (r.state = i),
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        (!(null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)) && (l.from != t || "bookmark" != s.type || (n && l.marker.insertLeft))) ||
                            ((o = null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)), (r = r || []).push(new Bt(s, l.from, o ? null : l.to)));
                    }
                return r;
            })(n, r, o),
            s = (function (e, t, n) {
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        (!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) && (l.from != t || "bookmark" != s.type || (n && !l.marker.insertLeft))) ||
                            ((o = null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)), (r = r || []).push(new Bt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)));
                    }
                return r;
            })(e, i, o),
            a = 1 == t.text.length,
        ...
        if (o)
            for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    ...
                    if (
                        !((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
                        ((u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= P(a.to, n) : 0 < P(a.to, n))) ||
                            (0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? P(a.from, r) <= 0 : P(a.from, r) < 0)))
                    )
                        return 1;
                }
            }
    ...
    function hn(e, t) {
        var n = ne("span", null, null, x ? "padding-right: .1px" : null),
            r = { pre: ne("pre", [n], "CodeMirror-line"), content: n, col: 0, pos: 0, cm: e, trailingSpace: !1, splitSpaces: e.getOption("lineWrapping") };
        t.measure = {};
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            !(function (e, t, n) {
                ...
                o.styleClasses &&
                    (o.styleClasses.bgClass && (r.bgClass = oe(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = oe(o.styleClasses.textClass, r.textClass || ""))),
                0 == r.map.length &&
                    r.map.push(
                        0,
                        0,
                        r.content.appendChild(
                            ...
                            null == Qe &&
                                ...
                                0 != l.firstChild.offsetHeight && (Qe = o.offsetWidth <= 1 && 2 < o.offsetHeight && !(w && v < 8))),
                            (l = Qe ? M("span", "​") : M("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px")).setAttribute("cm-text", ""),
                            l)
                        )
                    ),
        ...
        return (
            x && ((n = r.content.lastChild), (/\bcm-tab\b/.test(n.className) || (n.querySelector && n.querySelector(".cm-tab"))) && (r.content.className = "cm-tab-wrap-hack")),
                ...
                for (var c = document.createDocumentFragment(), h = 0; ; ) {
                    ...
                    "\t" == d[0]
                        ? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
                          (p = c.appendChild(M("span", we(f), "cm-tab"))).setAttribute("role", "presentation"),
                          p.setAttribute("cm-text", "\t"),
                          (e.col += f))
                        : ("\r" == d[0] || "\n" == d[0]
                              ? (p = c.appendChild(M("span", "\r" == d[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", d[0])
                              : ((p = e.cm.options.specialCharPlaceholder(d[0])).setAttribute("cm-text", d[0]), w && v < 9 ? c.appendChild(M("span", [p])) : c.appendChild(p)),
                          (e.col += 1)),
    ...
    function b(e, t) {
        var n = Ve(e, t);
        if (n.length)
            for (var r, i = Array.prototype.slice.call(arguments, 2), o = (vn ? (r = vn.delayedCallbacks) : yn ? (r = yn) : ((r = yn = []), setTimeout(bn, 0)), 0); o < n.length; ++o)
                !(function (e) {
                    r.push(function () {
        ...
        for (var i = 0; i < t.changes.length; i++) {
            ...
            if ("text" == o) {
                ...
                s.text == s.node && (s.node = u.pre),
                    ...
                    (s.text = u.pre),
                    u.bgClass != s.bgClass || u.textClass != s.textClass ? ((s.bgClass = u.bgClass), (s.textClass = u.textClass), Sn(l, s)) : a && (s.text.className = a);
    ...
    function Sn(e, t) {
        (e = e),
            (i = (n = t).bgClass ? n.bgClass + " " + (n.line.bgClass || "") : n.line.bgClass) && (i += " CodeMirror-linebackground"),
            n.background
                ? i
                    ? (n.background.className = i)
                    : (n.background.parentNode.removeChild(n.background), (n.background = null))
                : i && ((r = xn(n)), (n.background = r.insertBefore(M("div", null, i), r.firstChild)), e.display.input.setUneditable(n.background)),
            t.line.wrapClass ? (xn(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = "");
        var n,
            r,
            i = t.textClass ? t.textClass + " " + (t.line.textClass || "") : t.line.textClass;
        t.text.className = i || "";
    }
    function Ln(e, t, n, r) {
        ...
        if (t.widgets)
            for (var o = xn(n), l = 0, s = t.widgets; l < s.length; ++l) {
                ...
                c.noHScroll &&
                    ...
                    c.coverGutter || ((d -= f.gutterTotalWidth), (h.style.paddingLeft = f.gutterTotalWidth + "px")),
                    (h.style.width = d + "px")),
                    c.coverGutter && ((h.style.zIndex = 5), (h.style.position = "relative"), c.noHScroll || (h.style.marginLeft = -f.gutterTotalWidth + "px")),
    ...
    function Pn(e, t, n) {
        ...
        if (e.rest) {
            ...
            for (var i = 0; i < e.rest.length; i++) if (H(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
        }
    }
    function En(e, t, n, r) {
    ...
    function zn(e, t) {
        var n,
            ...
            o = In(e, i),
            e =
                (o && !o.text ? (o = null) : o && o.changes && (wn(e, o, i, ur(e)), (e.curOp.forceUpdate = !0)),
                o ||
                    ((e = e),
                    (r = H((n = Jt((n = t))))),
        ...
        if (t.cache.hasOwnProperty(l)) o = t.cache[l];
            ...
            (o = (function (e, t, n, r) {
                ...
                !(w && v < 9) ||
                    s ||
                    (i && (i.left || i.right)) ||
                    ((n = l.parentNode.getClientRects()[0]), (i = n ? { left: n.left, right: n.left + ar(e.display), top: n.top, bottom: n.bottom } : Gn));
                for (var n = i.top - t.rect.top, h = i.bottom - t.rect.top, d = (n + h) / 2, f = t.view.measure.heights, p = 0; p < f.length - 1 && !(d < f[p]); p++);
                var g = p ? f[p - 1] : 0,
                    m = f[p],
                    g = { left: ("right" == u ? i.right : i.left) - t.rect.left, right: ("left" == u ? i.left : i.right) - t.rect.left, top: g, bottom: m };
    ...
    function Un(e, t, n) {
        for (var r, i, o, l, s, a, u = 0; u < e.length; u += 3)
            if (
                ((s = e[u]),
                (a = e[u + 1]),
                t < s ? ((i = 0), (o = 1), (l = "left")) : t < a ? (o = (i = t - s) + 1) : (u == e.length - 3 || (t == a && e[u + 3] > t)) && ((i = (o = a - s) - 1), a <= t && (l = "right")),
                null != i)
            ) {
    ...
    function _n(e, t, n, r, i) {
        ...
        return (
            ...
            ("page" != r && "window" != r) ||
                ((i += (t = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Yn(ae(e)))), (t = t.left + ("window" == r ? 0 : Xn(ae(e)))), (n.left += t), (n.right += t)),
            (n.top += i),
            (n.bottom += i),
            n
        );
    ...
    function qn(e, t, n) {
        ...
        var r = t.left,
            t = t.top,
            n =
                ("page" == n ? ((r -= Xn(ae(e))), (t -= Yn(ae(e)))) : ("local" != n && n) || ((r += (n = e.display.sizer.getBoundingClientRect()).left), (t += n.top)),
            ...
            var s = (function (n, e, t, r, i) {
                        ...
                        f = !1;
                    {
                        ...
                        d
                            ...
                            : (u || (c != a && c != s) || c++,
                              (g = 0 == c || (c != e.text.length && Rn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u) ? "after" : "before"),
    ...
    function lr(e, t, n, r, i, o, l) {
        ...
        return (u = (u = (u = u || i[i.length - 1]).from < s ? { from: s, to: u.to, level: u.level } : u).to > a ? { from: u.from, to: a, level: u.level } : u);
    }
    function sr(e) {
    ...
    function ur(e) {
        ...
        return { fixedPos: cr(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: n, gutterWidth: r, wrapperWidth: t.wrapper.clientWidth };
    }
    function cr(e) {
    ...
    function fr(e, t, n, r) {
        ...
        return (
            r &&
                ...
                ((n = S(t, t.length, e.options.tabSize) - t.length), (i = F(i.line, Math.max(0, Math.round((o - Dn(e.display).left) / ar(e.display)) - n)))),
            i
        );
    }
    function pr(e, t) {
    ...
    function I(e, t, n, r) {
        ...
        var i,
            o = e.display,
            l =
                ((r = r || 0) && n < o.viewTo && (null == o.updateLineNumbers || o.updateLineNumbers > t) && (o.updateLineNumbers = t),
                ...
                t >= o.viewTo
                    ...
                    : t <= o.viewFrom
                    ? (l = vr(e, n, n + r, 1))
                        ? ((o.view = o.view.slice(l.index)), (o.viewFrom = l.lineN), (o.viewTo += r))
                        : mr(e)
                    : n >= o.viewTo
                    ? (l = vr(e, t, t, -1))
                    ...
                    : ((l = vr(e, t, t, -1)),
                      (i = vr(e, n, n + r, 1)),
                      l && i ? ((o.view = o.view.slice(0, l.index).concat(mn(e, l.lineN, i.lineN)).concat(o.view.slice(i.index))), (o.viewTo += r)) : mr(e)),
                o.externalMeasured);
    ...
    function gr(e, t, n) {
        ...
        i && t >= i.lineN && t < i.lineN + i.size && (r.externalMeasured = null),
            t < r.viewFrom || t >= r.viewTo || (null != (i = r.view[pr(e, t)]).node && -1 == L((r = i.changes || (i.changes = [])), n) && r.push(n));
    }
    function mr(e) {
    ...
    function wr(e, t) {
        ...
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
            (!t && c == n.sel.primIndex) ||
                ...
                ((a = s.empty()),
                l ? (u = l(e, s)) && xr(e, u, i) : (a || e.options.showCursorWhenSelecting) && xr(e, s.head, i),
                a ||
                    (function (i, e, t) {
                        var n = i.display,
                            o = i.doc,
                            ...
                            return (
                                (function (e, t, n, r) {
                                    ...
                                    var i,
                                        ...
                                        r = !C || r == C.length - 1;
                                    h.top - c.top <= 3
                                        ? ((i = (k ? d : f) && p ? S : (u ? c : h).left), (a = (k ? f : d) && r ? L : (u ? h : c).right), T(i, c.top, a - i, c.bottom))
                                        : ((a = u
                                              ? ((o = k && d && p ? S : c.left), (l = k ? L : x(e, n, "before")), (s = k ? S : x(t, n, "after")), k && f && r ? L : h.right)
                                              : ((o = k ? x(e, n, "before") : S), (l = !k && d && p ? L : c.right), (s = !k && f && r ? S : h.left), k ? x(t, n, "after") : L)),
                        ...
                        (n = e.from()), (r = e.to());
                        {
                            ...
                            n.line == r.line
                                ...
                                : ((e = W(o, n.line)),
                                  ...
                                  a && (n.top < e.top - 2 ? (T(n.right, n.top, null, n.bottom), T(S, e.top, e.left, e.bottom)) : T(n.right, n.top, e.left - n.right, n.bottom)),
    ...
    function xr(e, t, n) {
        ...
        (i.style.left = r.left + "px"),
            ...
            /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && ((t = (t = Zn(e, t, "div", null, null)).right - t.left), (i.style.width = (0 < t ? t : e.defaultCharWidth()) + "px")),
            r.other &&
                (((i = n.appendChild(M("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"))).style.display = ""),
    ...
    function Mr(e, t) {
        e.state.delayingBlurEvent ||
            (e.state.focused && (O(e, "blur", e, t), (e.state.focused = !1), ee(e.display.wrapper, "CodeMirror-focused")),
            ...
            if (!s.hidden) {
                (i += s.line.height),
                    w && v < 8
                        ...
                        : ((u = (h = s.node.getBoundingClientRect()).bottom - h.top), !a && s.text.firstChild && (c = s.text.firstChild.getBoundingClientRect().right - h.left - 1));
                var h,
                    a = s.line.height - u;
                if ((0.005 < a || a < -0.005) && (i < r && (o -= a), mt(s.line, u), Or(s.line), s.rest)) for (var d = 0; d < s.rest.length; d++) Or(s.rest[d]);
                c > e.display.sizerWidth &&
                    (a = Math.ceil(c / ar(e.display))) > e.display.maxLineLength &&
                    ((e.display.maxLineLength = a), (e.display.maxLine = s.line), (e.display.maxLineChanged = !0));
            }
        }
    ...
    function Ar(e, t, n) {
        ...
        return (
            n &&
                ...
                (n = n.ensure.to.line),
                r < i ? (o = vt(t, rn(W(t, (i = r))) + e.wrapper.clientHeight)) : Math.min(n, t.lastLine()) >= o && ((i = vt(t, rn(W(t, n)) - e.wrapper.clientHeight)), (o = n))),
    ...
    function Dr(e, t) {
        var n = e.display,
            ...
            r = t.bottom > s - r,
            r =
                (t.top < i ? (l.scrollTop = a ? 0 : t.top) : t.bottom > i + o && (a = Math.min(t.top, (r ? s : t.bottom) - o)) != i && (l.scrollTop = a),
        ...
        return (
            i && (t.right = t.left + o),
            t.left < 10 ? (l.scrollLeft = 0) : t.left < s ? (l.scrollLeft = Math.max(0, t.left + r - (i ? 0 : 10))) : t.right > o + s - 3 && (l.scrollLeft = t.right + (i ? 0 : 10) - o),
            l
        );
    }
    function Wr(e, t) {
    ...
    function Er(e, t, n, r) {
        t = Dr(e, { left: Math.min(t.left, n.left), top: Math.min(t.top, n.top) - r, right: Math.max(t.right, n.right), bottom: Math.max(t.bottom, n.bottom) + r });
    ...
    function Rr(e, t, n, r) {
        (t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth))),
            ((n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r) ||
                ((e.doc.scrollLeft = t), ii(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t));
    }
    function Br(e) {
        var t = e.display,
    ...
    (Gr.prototype.update = function (e) {
        ...
        (Gr.prototype.zeroWidthHack = function () {
            (this.horiz.style.height = this.vert.style.width = C && !c ? "12px" : "18px"),
    ...
    function Vr(e, t) {
        ...
        for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++)
            n != e.display.barWidth && e.options.lineWrapping && Nr(e), Kr(e, Br(e)), (n = e.display.barWidth), (r = e.display.barHeight);
    }
    function Kr(e, t) {
        var n = e.display,
    ...
    function Xr(n) {
        n.display.scrollbars && (n.display.scrollbars.clear(), n.display.scrollbars.addClass && ee(n.display.wrapper, n.display.scrollbars.addClass)),
            ...
            n.display.scrollbars.addClass && ie(n.display.wrapper, n.display.scrollbars.addClass);
    }
    var Yr = 0;
    function $r(e) {
        (e.curOp = {
            ...
            (e = e.curOp),
            vn ? vn.ops.push(e) : (e.ownsGroup = vn = { ops: [e], delayedCallbacks: [] });
    }
    function _r(e) {
        e = e.curOp;
        if (e) {
            var t = function (e) {
                ...
                for (var n = e.ops, r = 0; r < n.length; r++) {
                    ...
                    (function (e) {
                        ...
                        (i.mustUpdate =
                            ...
                            i.forceUpdate ||
                            null != i.scrollTop ||
                            (i.scrollToPos && (i.scrollToPos.from.line < l.viewFrom || i.scrollToPos.to.line >= l.viewTo)) ||
                            (l.maxLineChanged && o.options.lineWrapping)),
                        (i.update = i.mustUpdate && new Qr(o, i.mustUpdate && { top: i.scrollTop, ensure: i.scrollToPos }, i.forceUpdate));
                }
                ...
                for (var u = 0; u < n.length; u++) {
                    ...
                    (c.barMeasure = Br(h)),
                        d.maxLineChanged &&
                            ...
                            ((c.adjustWidthTo = En(h, d.maxLine, d.maxLine.text.length).left + 3),
                            (h.display.sizerWidth = c.adjustWidthTo),
                            (c.barMeasure.scrollWidth = Math.max(d.scroller.clientWidth, d.sizer.offsetLeft + c.adjustWidthTo + Wn(h) + h.display.barWidth)),
                            (c.maxScrollLeft = Math.max(0, d.sizer.offsetLeft + c.adjustWidthTo - Hn(h))));
                ...
                for (var f = 0; f < n.length; f++) {
                    ...
                    null != p.adjustWidthTo &&
                        ...
                        p.maxScrollLeft < g.doc.scrollLeft && Rr(g, Math.min(g.display.scroller.scrollLeft, p.maxScrollLeft), !0),
                        ...
                        ((v = (function (e, t, n, r) {
                            null == r && (r = 0),
                                e.options.lineWrapping ||
                                    t != n ||
                                    ((n = "before" == t.sticky ? F(t.line, t.ch + 1, "before") : t), (t = t.ch ? F(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after") : t));
                            for (var i = 0; i < 5; i++) {
                                var o,
                                    l = !1,
                                    s = Qn(e, t),
                                    a = n && n != t ? Qn(e, n) : s,
                                    s = Dr(e, (o = { left: Math.min(s.left, a.left), top: Math.min(s.top, a.top) - r, right: Math.max(s.left, a.left), bottom: Math.max(s.bottom, a.bottom) + r })),
                                    a = e.doc.scrollTop,
                                    u = e.doc.scrollLeft;
                                if (
                                    (null != s.scrollTop && (Ir(e, s.scrollTop), 1 < Math.abs(e.doc.scrollTop - a) && (l = !0)),
                                    null != s.scrollLeft && (Rr(e, s.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - u) && (l = !0)),
                                    !l)
                                )
                                    break;
                            }
                            return o;
                        })(w, E(C, b.scrollToPos.from), E(C, b.scrollToPos.to), b.scrollToPos.margin)),
                        (function (e, t) {
                            var n, r, i, o;
                            A(e, "scrollCursorIntoView") ||
                                ...
                                t.top + o.top < 0 ? (r = !0) : t.bottom + o.top > (i.defaultView.innerHeight || i.documentElement.clientHeight) && (r = !1),
                                null == r ||
                                    X ||
                                    ((o = M(
                                        "div",
        ...
        c.highlightFrontier >= l.display.viewTo ||
            ...
            c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function (e) {
                if (a.line >= l.display.viewFrom) {
                    for (
                        var t = e.styles,
                            n = e.text.length > l.options.maxHighlightLength ? ht(c.mode, a.state) : null,
                            r = Nt(l, e, a, !0),
                            n = (n && (a.state = n), (e.styles = r.styles), e.styleClasses),
                            r = r.classes,
                            i =
                                (r ? (e.styleClasses = r) : n && (e.styleClasses = null),
                                !t || t.length != e.styles.length || (n != r && (!n || !r || n.bgClass != r.bgClass || n.textClass != r.textClass))),
                            o = 0;
                        !i && o < t.length;
                        ++o
                    )
    ...
    function Jr(e, t) {
        ...
        if (!t.force && t.visible.from >= n.viewFrom && t.visible.to <= n.viewTo && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo) && n.renderedView == n.view && 0 == yr(e))
            return !1;
        ...
        var i = r.first + r.size,
            ...
            i =
                ((i = o),
                (o = l),
                0 == (c = (l = e).display).view.length || i >= c.viewTo || o <= c.viewFrom
                    ? ((c.view = mn(l, i, o)), (c.viewFrom = i))
                    : (c.viewFrom > i ? (c.view = mn(l, i, c.viewFrom).concat(c.view)) : c.viewFrom < i && (c.view = c.view.slice(pr(l, i))),
                      (c.viewFrom = i),
                      c.viewTo < o ? (c.view = c.view.concat(mn(l, c.viewTo, o))) : c.viewTo > o && (c.view = c.view.slice(0, pr(l, o)))),
                (c.viewTo = o),
        ...
        for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
            ...
            if (!y.hidden)
                if (y.node && y.node.parentNode == d) {
                    ...
                    y.changes && (-1 < L(y.changes, "gutter") && (b = !1), wn(s, y, m, u)),
                        b && (te(y.lineNumber), y.lineNumber.appendChild(document.createTextNode(bt(s.options, m)))),
        ...
        return (
            ...
            r && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), qr(e, 400)),
    ...
    function ei(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            if (r && e.options.lineWrapping && t.oldDisplayWidth != Hn(e)) r && (t.visible = Ar(e.display, e.doc, n));
                ...
                (n && null != n.top && (n = { top: Math.min(e.doc.height + An(e.display) - Fn(e), n.top) }),
        ...
        if (e.options.lineNumbers)
            return (
                ...
                t.length != n.lineNumChars
                    ? ((r = (i = n.measure.appendChild(M("div", [M("div", t)], "CodeMirror-linenumber CodeMirror-gutter-elt"))).firstChild.offsetWidth),
                      (i = i.offsetWidth - r),
                      (n.lineGutter.style.width = ""),
                      (n.lineNumInnerWidth = Math.max(r, n.lineGutter.offsetWidth - i) + 1),
    ...
    function ui(e, t, n, r) {
        var i = this,
            o =
                ...
                (i.lineSpace = ne("div", [i.measure, i.lineMeasure, i.selectionDiv, i.cursorDiv, i.lineDiv], null, "position: relative; outline: none")),
                ne("div", [i.lineSpace], "CodeMirror-lines"));
        (i.mover = M("div", [o], null, "position: relative")),
            (i.sizer = M("div", [i.mover], "CodeMirror-sizer")),
            (i.sizerWidth = null),
            (i.heightForcer = M("div", null, null, "position: absolute; height: " + fe + "px; width: 1px;")),
    ...
    function pi(e, t) {
        ...
        if ((r && s) || (n && a)) {
            ...
            n &&
                null != i &&
                ((a = (s = e.doc.scrollTop) + o.wrapper.clientHeight), (i = n * i) < 0 ? (s = Math.max(0, s + i - 50)) : (a = Math.min(e.doc.height, a + i + 50)), ti(e, { top: s, bottom: a })),
                ci < 20 &&
                    0 !== t.deltaMode &&
                    (null == o.wheelStartX
                        ? ((o.wheelStartX = l.scrollLeft),
                          ...
                          setTimeout(function () {
                              ...
                              null != o.wheelStartX &&
                                  ...
                                  (t = ((t = l.scrollTop - o.wheelStartY) && o.wheelDY && t / o.wheelDY) || (e && o.wheelDX && e / o.wheelDX)),
    ...
    function gi(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            var o,
                ...
                a = P(s.to(), l.from());
            (r && !l.empty() ? 0 < a : 0 <= a) &&
                ((a = St(s.from(), l.from())), (o = Ct(s.to(), l.to())), (l = s.empty() ? l.from() == l.head : s.from() == s.head), i <= n && --n, t.splice(--i, 2, new G(l ? o : a, l ? a : o)));
        }
        return new B(t, n);
    }
    function mi(e, t) {
    ...
    function Li(e, o, t, l) {
        ...
        o.full
            ...
            ? 1 == c.length
                ...
                : ((s = r(1, c.length - 1)).push(new sn(f + h.text.slice(u.ch), p, l)), n(h, h.text.slice(0, a.ch) + c[0], i(0)), e.insert(a.line + 1, s))
            : 1 == c.length
            ? (n(h, h.text.slice(0, a.ch) + c[0] + d.text.slice(u.ch), i(0)), e.remove(a.line + 1, g))
            : (n(h, h.text.slice(0, a.ch) + c[0], i(0)), n(d, f + d.text.slice(u.ch), p), (s = r(1, c.length - 1)), 1 < g && e.remove(a.line + 1, g - 1), e.insert(a.line + 1, s)),
            b(e, "change", e, o);
    }
    function ki(e, s, a) {
        !(function e(t, n, r) {
    ...
    function Di(e, t, n, r) {
        ...
        if (
            (l.lastOp == r ||
                (l.lastOrigin == t.origin && t.origin && (("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500)) || "*" == t.origin.charAt(0)))) &&
            (o =
                (o = l).lastOp == r
                    ? (Ai(o.done), z(o.done))
            ...
            (i = z(o.changes)), 0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? (i.to = vi(t)) : o.changes.push(Oi(e, t));
        else {
            var a = z(l.done);
            for ((a && a.ranges) || Hi(e.sel, l.done), o = { changes: [Oi(e, t)], generation: l.generation }, l.done.push(o); l.done.length > l.undoDepth; )
        ...
        for (var r = [], i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) r.push(n ? B.prototype.deepCopy.call(o) : o);
                ...
                for (var a = 0; a < l.length; ++a) {
                    var u,
                        c = l[a];
                    if ((s.push({ from: c.from, to: c.to, text: c.text }), t)) for (var h in c) (u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && ((z(s)[h] = c[h]), delete c[h]);
                }
            }
        }
        return r;
    ...
    function Ki(e, t, n) {
        (je(e, "beforeSelectionChange") || (e.cm && je(e.cm, "beforeSelectionChange"))) &&
            ((r = e),
            (o = n),
            (o = {
                ranges: (i = t).ranges,
        ...
        var r,
            i,
            o = (n && n.bias) || (P(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
    ...
    function Ji(e, t, n) {
        ...
        if (!(je(e, "beforeChange") || (e.cm && je(e.cm, "beforeChange"))) || (t = Qi(e, t, !0))) {
            ...
            if (r) for (var i = r.length - 1; 0 <= i; --i) eo(e, { from: r[i].from, to: r[i].to, text: i ? [""] : t.text, origin: t.origin });
            else eo(e, t);
        }
    }
    function eo(e, n) {
            ...
            if (u != s.length) {
                ...
                for (
                    ...
                    var f = (function (e) {
                        ...
                        c.push(Oi(i, n));
                        var t = e ? bi(i, n) : z(s),
                            r = (ro(i, n, t, Ei(i, n)), !e && i.cm && i.cm.scrollIntoView({ from: n.from, to: vi(n) }), []);
                        ki(i, function (e, t) {
    ...
    function ro(e, t, n, r) {
        ...
        if (t.to.line < e.first) no(e, t.text.length - 1 - (t.to.line - t.from.line));
            ...
            t.from.line < e.first && (no(e, (i = t.text.length - 1 - (e.first - t.from.line))), (t = { from: F(e.first, 0), to: F(t.to.line + i, t.to.ch), text: [z(t.text)], origin: t.origin }));
            var i = e.lastLine();
            if ((((t = t.to.line > i ? { from: t.from, to: F(i, W(e, i).text.length), text: [t.text[0]], origin: t.origin } : t).removed = pt(e, t.from, t.to)), (n = n || bi(e, t)), e.cm)) {
                var i = e.cm,
                    o = t,
                    l = r,
                    s = i.doc,
                ...
                qr(i, 400),
                    ...
                    o.full ? I(i) : u.line != c.line || 1 != o.text.length || Si(i.doc, o) ? I(i, u.line, c.line + 1, l) : gr(i, u.line, "text"),
                    (d = je(i, "changes")),
                    ((s = je(i, "change")) || d) &&
                        ((l = { from: u, to: c, text: o.text, removed: o.removed, origin: o.origin }), s && b(i, "change", i, l), d && (i.curOp.changeObjs || (i.curOp.changeObjs = [])).push(l)),
    ...
    function io(e, t, n, r, i) {
        var o;
        P((r = r || n), n) < 0 && ((n = (o = [r, n])[0]), (r = o[1])), "string" == typeof t && (t = e.splitLines(t)), Ji(e, { from: n, to: r, text: t, origin: i });
    }
    function oo(e, t, n, r) {
            ...
            maybeSpill: function () {
                if (!(this.children.length <= 10)) {
                    ...
                    do {
                        ...
                        (e.parent
                            ? ((e.size -= n.size), (e.height -= n.height), (t = L(e.parent.children, e)), e.parent.children.splice(t + 1, 0, n))
                            : ((((t = new co(e.children)).parent = e).children = [t, n]), (e = t)),
                        (n.parent = e.parent),
    ...
    function mo(r, i, o, e, t) {
        ...
        if (
            (d.replacedWith &&
                ...
                e.handleMouseEvents || d.widgetNode.setAttribute("cm-ignore-events", "true"),
        ...
        if (
            (r.iter(g, o.line + 1, function (e) {
                var t, n;
                m && d.collapsed && !m.options.lineWrapping && Jt(e) == m.display.maxLine && (p = !0),
                    d.collapsed && g != i.line && mt(e, 0),
                    (e = e),
                    (t = new Bt(d, g == i.line ? i.ch : null, g == o.line ? o.ch : null)),
                    (n = (n = r.cm && r.cm.curOp) && window.WeakSet && (n.markedSpans || (n.markedSpans = new WeakSet()))) && e.markedSpans && n.has(e.markedSpans)
            ...
            d.readOnly && ((zt = !0), (r.history.done.length || r.history.undone.length) && r.clearHistory()),
            d.collapsed && ((d.id = ++go), (d.atomic = !0)),
            m)
        ) {
            if ((p && (m.curOp.updateMaxLine = !0), d.collapsed)) I(m, i.line, o.line + 1);
            else if (d.className || d.startStyle || d.endStyle || d.css || d.attributes || d.title) for (var v = i.line; v <= o.line; v++) gr(m, v, "text");
    ...
    (po.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            for (
                var e, t = this.doc.cm, n = t && !t.curOp, r = (n && $r(t), !je(this, "clear") || ((e = this.find()) && b(this, "clear", e.from, e.to)), null), i = null, o = 0;
                o < this.lines.length;
                ++o
            ) {
                var l = this.lines[o],
                    s = Gt(l.markedSpans, this);
                t && !this.collapsed ? gr(t, H(l), "text") : t && (null != s.to && (i = H(l)), null != s.from && (r = H(l))),
                    (l.markedSpans = (function (e, t) {
                        for (var n, r = 0; r < e.length; ++r) e[r] != t && (n = n || []).push(e[r]);
                        return n;
                    })(l.markedSpans, s)),
                    null == s.from && this.collapsed && !nn(this.doc, l) && t && mt(l, sr(t.display));
            }
            ...
            r &&
                ...
                h(o, function () {
                    ...
                    t && (Vn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
                        ...
                        nn(i.doc, e) || null == i.height || ((t = i.height), (i.height = null), (t = Mn(i) - t) && mt(e, e.height + t)),
        ...
        (po.prototype.attachLine = function (e) {
            ...
            this.lines.length ||
                !this.doc.cm ||
                ((t = this.doc.cm.curOp).maybeHiddenMarkers && -1 != L(t.maybeHiddenMarkers, this)) ||
        ...
        xo =
            (((f.prototype = Se(co.prototype, {
                ...
                setValue: n(function (e) {
                    ...
                    Ji(this, { from: t, to: F(n, W(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 }, !0), this.cm && Fr(this.cm, 0, 0), U(this, mi(t), ge);
                }),
                    ...
                    return (
                        ...
                        ao(r, e, "widget", function (e) {
                            ...
                            return (
                                ...
                                (i.line = e),
                                o && !nn(r, e) && ((t = rn(e) < r.scrollTop), mt(e, e.height + Mn(i)), t && Wr(o, i.height), (o.curOp.forceUpdate = !0)),
                                1
                            );
                        }),
                    ...
                    for (
                        var t = this.first,
                            ...
                            n =
                                ...
                                new f(gt(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction)),
                            r =
            ...
            if (t && !r.isReadOnly())
                if (n && n.length && window.FileReader && window.File)
                    for (
                        ...
                        !(function (e, t) {
                            var n;
                            r.options.allowDropFileTypes && -1 == L(r.options.allowDropFileTypes, e.type)
                                ? s()
    ...
    function Vo(e, t, n, r, i) {
        if (e) {
            ...
            if (e)
                return (
                    (o = i < 0 == (1 == (e = i < 0 ? z(e) : e[0]).level) ? "after" : "before"),
    ...
    var jo = {
        ...
        killLine: function (n) {
            return Bo(n, function (e) {
                var t;
                return e.empty()
                    ? ((t = W(n.doc, e.head.line).text.length), e.head.ch == t && e.head.line < n.lastLine() ? { from: e.head, to: F(e.head.line + 1, 0) } : { from: e.head, to: F(e.head.line, t) })
                    : { from: e.from(), to: e.to() };
            });
        },
                    ...
                    r[o].empty() &&
                        ...
                        (t = W(l.doc, e.line).text) &&
                            (0 < (e = e.ch == t.length ? new F(e.line, e.ch - 1) : e).ch
                                ? ((e = new F(e.line, e.ch + 1)), l.replaceRange(t.charAt(e.ch - 1) + t.charAt(e.ch - 2), F(e.line, e.ch - 2), e, "+transpose"))
                                : e.line > l.doc.first &&
                                  (n = W(l.doc, e.line - 1).text) &&
                                  ((e = new F(e.line, 1)), l.replaceRange(t.charAt(0) + l.doc.lineSeparator() + n.charAt(n.length - 1), F(e.line - 1, n.length - 1), e, "+transpose"))),
                        i.push(new G(e, e)));
                l.setSelections(i);
            });
        },
    ...
    function el(e) {
        ...
        (e.target && e.target != i.display.input.getField()) ||
            ...
            A(i, e) ||
                ...
                (n = Qo(i, e)),
                K && ((Jo = n ? t : null), !n && 88 == t && !rt && (C ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
                d && !C && !n && 46 == t && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
                18 != t ||
                    /\bCodeMirror-crosshair\b/.test(i.display.lineDiv.className) ||
                    (ie((r = i.display.lineDiv), "CodeMirror-crosshair"), k(document, "keyup", o), k(document, "mouseover", o))));
    }
    function tl(e) {
                              ...
                              ? ((i = c),
                                ...
                                (i.options.dragDrop &&
                                          ...
                                          var o = t.display,
                                              ...
                                              s = R(t, function (e) {
                                                  x && (o.scroller.draggable = !1),
                                                      ...
                                                      t.state.delayingBlurEvent && (t.hasFocus() ? (t.state.delayingBlurEvent = !1) : kr(t)),
                                    ...
                                    : function (d, e, f, p) {
                                          ...
                                          "rectangle" == p.unit
                                              ? (p.addNew || (m = new G(f, f)), (f = fr(d, e, !0, !0)), (v = -1))
                                              : ((e = sl(d, f, p.unit)), (m = p.extend ? zi(m, e.anchor, e.head, p.extend) : e));
                                          p.addNew
                                              ? -1 == v
                                                  ? ((v = t.length), U(g, gi(d, t.concat([m]), v), { scroll: !1, origin: "*mouse" }))
                                                  : 1 < t.length && t[v].empty() && "char" == p.unit && !p.extend
                                                  ? (U(g, gi(d, t.slice(0, v).concat(t.slice(v + 1)), 0), { scroll: !1, origin: "*mouse" }), (y = g.sel))
                                                  : Gi(g, v, m, me)
                                          ...
                                          function s(e) {
                                              if (0 != P(b, e))
                                                  if (((b = e), "rectangle" == p.unit)) {
                                                      ...
                                                      t.length || t.push(new G(f, f)), U(g, gi(d, y.ranges.slice(0, v).concat(t), v), { origin: "*mouse", scroll: !1 }), d.scrollIntoView(e);
                                                  } else {
                                                      var h,
                                                          r = m,
                                                          i = sl(d, e, p.unit),
                                                      ...
                                                      (r[v] = (function (e, t) {
                                                          ...
                                                          l =
                                                              r.line != n.line
                                                                  ...
                                                                  : ((e = He(i, r.ch, r.sticky)), (o = e - o || (r.ch - n.ch) * (1 == l.level ? -1 : 1)), e == s - 1 || e == s ? o < 0 : 0 < o);
    ...
    function ml(e) {
        e.options.lineWrapping ? (ie(e.display.wrapper, "CodeMirror-wrap"), (e.display.sizer.style.minWidth = ""), (e.display.sizerWidth = null)) : (ee(e.display.wrapper, "CodeMirror-wrap"), ln(e)),
            dr(e),
            I(e),
            jn(e),
            setTimeout(function () {
    ...
    function p(e, t) {
        ...
        k(s.scroller, "touchstart", function (e) {
            ...
            A(l, e) ||
                ...
                clearTimeout(a),
                (t = +new Date()),
                (s.activeTouch = { start: t, moved: !1, prev: t - u.end <= 300 ? u : null }),
            ...
            k(s.scroller, "touchend", function (e) {
                ...
                n &&
                    ...
                    (n = !n.prev || h(n, n.prev) ? new G(t, t) : !n.prev.prev || h(n, n.prev.prev) ? l.findWordAt(t) : new G(F(t.line, 0), E(l.doc, F(t.line + 1, 0)))),
                    ...
                    A(l, e) ||
                        ((n = fr((t = l), (n = e))) &&
                            ...
                            t.display.dragCursor ||
                                ((t.display.dragCursor = M("div", null, "CodeMirror-cursors CodeMirror-dragcursors")), t.display.lineSpace.insertBefore(t.display.dragCursor, t.display.cursorDiv)),
                        ...
                        w && (!t.state.draggingText || +new Date() - xo < 100)
                            ...
                            : A(t, e) ||
                              ...
                              e.dataTransfer.setDragImage &&
                                  !j &&
                                  (((n = M("img", null, null, "position: fixed; left: 0; top: 0;")).src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
                                  K && ((n.width = n.height = 1), t.display.wrapper.appendChild(n), (n._top = n.offsetTop)),
                ...
                f =
                    (f.empty() &&
                        (n && 0 < n
                            ? (p = F(p.line, p.ch - n))
                            : e.state.overwrite && !s
                            ? (g = F(g.line, Math.min(W(o, g.line).text.length, g.ch + z(a).length)))
                            : s && bl && bl.lineWise && bl.text.join("\n") == a.join("\n") && (p = g = F(p.line, 0))),
                    { from: p, to: g, text: u ? u[d % u.length] : a, origin: i || (s ? "paste" : e.state.cutIncoming > l ? "cut" : "+input") });
                ...
                (t =
                    "codepoint" == o
                        ? ((t = s.text.charCodeAt(r.ch + (0 < i ? 0 : -1))),
                          isNaN(t) ? null : ((t = 0 < i ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343), new F(r.line, Math.max(0, Math.min(s.text.length, r.ch + i * (t ? 2 : 1))), -i)))
                        : l
                        ? Ko(n.cm, s, r, i)
                        : Uo(s, r, i))
            ) {
    ...
    function Nl(e, t, n, r) {
        ...
        for (
            "page" == r
                ? ((i = Math.min(e.display.wrapper.clientHeight, ue(e).innerHeight || s(e).documentElement.clientHeight)),
    ...
    (r.prototype.init = function (e) {
        ...
        function n(e) {
            if (a(e) && !A(l, e)) {
                if (l.somethingSelected()) wl({ lineWise: !1, text: l.getSelections() }), "cut" == e.type && l.replaceSelection("", null, "cut");
                else {
        ...
        (s.contentEditable = !0),
            kl(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize),
        ...
        (r.prototype.showPrimarySelection = function () {
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || n.line < t.display.viewFrom) e.removeAllRanges();
                ...
                if (!i || i.bad || !o || o.bad || 0 != P(St(i, o), r) || 0 != P(Ct(i, o), n)) {
                    ...
                    if ((r || (r = { node: (i = (n = i[i.length - 1].measure).maps ? n.maps[n.maps.length - 1] : n.map)[i.length - 1], offset: i[i.length - 2] - i[i.length - 3] }), o && r)) {
                        var l,
                        ...
                        l &&
                            (!d && t.state.focused ? (e.collapse(o.node, o.offset), l.collapsed || (e.removeAllRanges(), e.addRange(l))) : (e.removeAllRanges(), e.addRange(l)),
                            n && null == e.anchorNode ? e.addRange(n) : d && this.startGracePeriod()),
        ...
        (r.prototype.pollContent = function () {
            ...
            var e,
                ...
                r = r.to();
            if (
                (0 == i.ch && i.line > t.firstLine() && (i = F(i.line - 1, W(t.doc, i.line - 1).length)),
                r.ch == W(t.doc, r.line).text.length && r.line < t.lastLine() && (r = F(r.line + 1, 0)),
                                ...
                                !(function e(t) {
                                    if (1 == t.nodeType) {
                                        ...
                                        if (n) d(n);
                                            ...
                                            ((n = /^(pre|div|p|li|table|br)$/i.test(t.nodeName)), /^br$/i.test(t.nodeName) || 0 != t.textContent.length)
                                        ) {
                                            n && h();
            ...
            for (
                var p = z(s), g = z(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0));
                c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1);
    ...
    (i.prototype.init = function (n) {
        ...
        function t(e) {
            if (!A(i, e)) {
                if (i.somethingSelected()) wl({ lineWise: !1, text: i.getSelections() });
                    ...
                    var t = Ll(i);
                    wl({ lineWise: !0, text: t.text }), "cut" == e.type ? i.setSelections(t.ranges, null, ge) : ((r.prevInput = ""), (o.value = t.text.join("\n")), se(o));
                }
        ...
        (i.prototype.prepareSelection = function () {
            ...
            return (
                t.options.moveInputWithCursor &&
                    ...
                    (i.teTop = Math.max(0, Math.min(n.wrapper.clientHeight - 10, t.top + e.top - r.top))),
                    (i.teLeft = Math.max(0, Math.min(n.wrapper.clientWidth - 10, t.left + e.left - r.left)))),
                i
            );
        }),
        ...
        (i.prototype.reset = function (e) {
            ...
            this.contextMenuPending ||
                ...
                ((t = this.cm).somethingSelected()
                    ? ((this.prevInput = ""), (n = t.getSelection()), (this.textarea.value = n), t.state.focused && se(this.textarea), w && 9 <= v && (this.hasSelection = n))
        ...
        (i.prototype.focus = function () {
            if ("nocursor" != this.cm.options.readOnly && (!_ || N(this.textarea.ownerDocument) != this.textarea))
                try {
                    this.textarea.focus();
                } catch (e) {}
        }),
        ...
        (i.prototype.poll = function () {
            ...
            return (
                h(t, function () {
                    xl(t, i.slice(l), r.length - l, null, e.composing ? "*compose" : null),
        ...
        (i.prototype.onContextMenu = function (e) {
            ...
            function d() {
                ...
                o.contextMenuPending == d &&
                    ...
                    null != a.selectionStart &&
                        ...
                        (e = 0),
                        (t = function () {
                            s.selForContextMenu == l.doc.sel && 0 == a.selectionStart && 0 < a.selectionEnd && "​" == o.prevInput
                                ? R(l, Zi)(l)
                                : e++ < 10
            ...
            u &&
                !K &&
                (l.options.resetSelectionOnContextMenu && -1 == l.doc.sel.contains(u) && R(l, U)(l.doc, mi(u), ge),
                (n = a.style.cssText),
        ...
        (Fl.prototype = {
            ...
            addOverlay: t(function (e, t) {
                ...
                for (
                    var r = this.state.overlays,
                        n = { mode: n, modeSpec: e, opaque: t && t.opaque, priority: (t && t.priority) || 0 },
                        i = function (e) {
                            return e.priority;
                        },
                        o = 0,
                ...
                (t.style.position = "absolute"),
                    ...
                    "over" == r
                        ...
                        : ("above" != r && "near" != r) ||
                          ...
                          ("above" == r || e.bottom + t.offsetHeight > l) && e.top > t.offsetHeight ? (a = e.top - t.offsetHeight) : e.bottom + t.offsetHeight <= l && (a = e.bottom),
                          u + t.offsetWidth > o && (u = o - t.offsetWidth)),
                    (t.style.top = a + "px"),
                    (t.style.left = t.style.right = ""),
                    "right" == i
                        ? ((u = s.sizer.clientWidth - t.offsetWidth), (t.style.right = "0px"))
                        : ("left" == i ? (u = 0) : "middle" == i && (u = (s.sizer.clientWidth - t.offsetWidth) / 2), (t.style.left = u + "px")),
                    n &&
                        ((r = this),
                        (l = { left: u, top: a, right: u + t.offsetWidth, bottom: a + t.offsetHeight }),
                ...
                if (t) {
                    for (
                        var i = this.getHelper(e, "wordChars"),
                            o = (("before" != e.sticky && r != t.length) || !n ? ++r : --n, t.charAt(n)),
                            l = Te(o, i)
                                ? function (e) {
                                      return Te(e, i);
                                  }
            ...
            toggleOverwrite: function (e) {
                (null != e && e == this.state.overwrite) ||
                    (((this.state.overwrite = !this.state.overwrite) ? ie : ee)(this.display.cursorDiv, "CodeMirror-overwrite"), O(this, "overwriteToggle", this, this.state.overwrite));
            },
            hasFocus: function () {
            ...
            scrollIntoView: t(function (e, t) {
                ...
                null == e
                    ...
                    e.to || (e.to = e.from),
                    (e.margin = t || 0),
                    null != e.from.line ? ((t = e), Pr((n = this)), (n.curOp.scrollToPos = t)) : Er(this, e.from, e.to, e.margin);
            }),
            ...
            refresh: t(function () {
                ...
                I(this),
                    ...
                    ni(this.display),
                    (null == e || 0.5 < Math.abs(e - sr(this.display)) || this.options.lineWrapping) && dr(this),
                    O(this, "refresh", this);
            }),
    ...
    return (
        ...
        (p.fromTextArea = function (t, n) {
            ...
            if (
                ...
                null == n.autofocus && ((e = N(t.ownerDocument)), (n.autofocus = e == t || (null != t.getAttribute("autofocus") && e == document.body))),
                ...
                (e.save = r),
                    ...
                    (e.toTextArea = function () {
                        (e.toTextArea = isNaN),
                            ...
                            (t.style.display = ""),
                            t.form && (T(t.form, "submit", r), n.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = o));
                    });
            }),
